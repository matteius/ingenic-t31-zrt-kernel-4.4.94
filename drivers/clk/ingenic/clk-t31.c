...
static struct ingenic_fixed_rate_clock t31_fixed_rate_ext_clks[] __initdata = {
	FRATE(CLK_EXT, "ext", NULL, 1, 24000000),
	FRATE(CLK_RTC_EXT, "rtc_ext", NULL, 1, 32768),
};
...
static struct ingenic_gate_clock t31_gate_clks[] __initdata = {
	...
	GATE(CLK_GATE_DES,	    "gate_des",		    "div_apb",	    CPM_CLKGR,  28, CLK_IGNORE_UNUSED,		CLK_GATE_SET_TO_DISABLE),
	GATE(CLK_GATE_RSA,	    "gate_rsa",		    "div_rsa",	    CPM_CLKGR,  27, CLK_IGNORE_UNUSED,		CLK_GATE_SET_TO_DISABLE),
	GATE(CLK_GATE_RISCV,    "gate_riscv",		"div_riscv",	CPM_CLKGR,  26, CLK_IGNORE_UNUSED,		CLK_GATE_SET_TO_DISABLE),
	GATE(CLK_GATE_MIPI_CSI, "gate_csi",		    "div_ahb0",	    CPM_CLKGR,  25, CLK_IGNORE_UNUSED,		CLK_GATE_SET_TO_DISABLE),
	GATE(CLK_GATE_LCD,	    "gate_lcd",		    "div_lcd",	    CPM_CLKGR,  24, CLK_IGNORE_UNUSED,		CLK_GATE_SET_TO_DISABLE),
	...
	GATE(CLK_GATE_SFC,	    "gate_sfc",		    "div_sfc",	    CPM_CLKGR,  20, CLK_IGNORE_UNUSED,		CLK_GATE_SET_TO_DISABLE),
	GATE(CLK_GATE_SSI1,	    "gate_ssi1",		"div_ssi",	    CPM_CLKGR,  19, CLK_IGNORE_UNUSED,		CLK_GATE_SET_TO_DISABLE),
	GATE(CLK_GATE_HASH,	    "gate_hash",		"div_ahb2",	    CPM_CLKGR,  18, CLK_IGNORE_UNUSED,		CLK_GATE_SET_TO_DISABLE),
	GATE(CLK_GATE_SLV,	    "gate_slv",		    "div_apb",	    CPM_CLKGR,  17, CLK_IGNORE_UNUSED,		CLK_GATE_SET_TO_DISABLE),
	GATE(CLK_GATE_UART2,	"gate_uart2",		"div_apb",	    CPM_CLKGR,  16, CLK_IGNORE_UNUSED,		CLK_GATE_SET_TO_DISABLE),
	GATE(CLK_GATE_UART1,	"gate_uart1",		"div_apb",	    CPM_CLKGR,  15, CLK_IGNORE_UNUSED,		CLK_GATE_SET_TO_DISABLE),
	GATE(CLK_GATE_UART0,	"gate_uart0",		"div_apb",	    CPM_CLKGR,  14, CLK_IGNORE_UNUSED,		CLK_GATE_SET_TO_DISABLE),
	GATE(CLK_GATE_SADC,	    "gate_sadc",		"div_apb",	    CPM_CLKGR,  13, CLK_IGNORE_UNUSED,		CLK_GATE_SET_TO_DISABLE),
	GATE(CLK_GATE_DMIC,	    "gate_dmic",		"mux_apb",	    CPM_CLKGR,  12, CLK_IGNORE_UNUSED,		CLK_GATE_SET_TO_DISABLE),
	GATE(CLK_GATE_AIC,	    "gate_aic",		    "div_i2st",	    CPM_CLKGR,  11, CLK_IGNORE_UNUSED,		CLK_GATE_SET_TO_DISABLE),
	GATE(CLK_GATE_SMB1,	    "gate_i2c1",		"div_apb",	    CPM_CLKGR,  8,  CLK_IGNORE_UNUSED,		CLK_GATE_SET_TO_DISABLE),
	GATE(CLK_GATE_SMB0,	    "gate_i2c0",		"div_apb",	    CPM_CLKGR,  7,  CLK_IGNORE_UNUSED,		CLK_GATE_SET_TO_DISABLE),
	GATE(CLK_GATE_SSI0,	    "gate_ssi0",		"div_ssi",	    CPM_CLKGR,  6,  CLK_IGNORE_UNUSED,		CLK_GATE_SET_TO_DISABLE),
	GATE(CLK_GATE_MSC1,	    "gate_msc1",		"div_msc1",	    CPM_CLKGR,  5,  CLK_IGNORE_UNUSED,		CLK_GATE_SET_TO_DISABLE),
	GATE(CLK_GATE_MSC0,	    "gate_msc0",		"div_msc0",	    CPM_CLKGR,  4,  CLK_IGNORE_UNUSED,		CLK_GATE_SET_TO_DISABLE),
	GATE(CLK_GATE_OTG,	    "gate_otg",		    "div_ahb2",	    CPM_CLKGR,  3,  CLK_IGNORE_UNUSED,		CLK_GATE_SET_TO_DISABLE),
	GATE(CLK_GATE_EFUSE,	"gate_efuse",		"div_ahb2",	    CPM_CLKGR,  1,  CLK_IGNORE_UNUSED,			CLK_GATE_HIWORD_MASK),
	GATE(CLK_GATE_NEMC,	    "gate_nemc",		"div_ahb2",	    CPM_CLKGR,  0,  CLK_IGNORE_UNUSED,		CLK_GATE_SET_TO_DISABLE),
	GATE(CLK_GATE_CPU,	    "gate_cpu",		    "div_cpu",	    CPM_CLKGR1, 15, CLK_IGNORE_UNUSED,  		CLK_GATE_SET_TO_DISABLE),
	...
	GATE(CLK_GATE_AHB1,	    "gate_ahb1",		"div_ahb2",	    CPM_CLKGR1, 6,  CLK_IGNORE_UNUSED,		CLK_GATE_SET_TO_DISABLE),
	GATE(CLK_GATE_AES,	    "gate_aes",		    "div_ahb2",	    CPM_CLKGR1, 5,  CLK_IGNORE_UNUSED,		CLK_GATE_SET_TO_DISABLE),
	GATE(CLK_GATE_GMAC,	    "gate_gmac",		"div_macphy",	CPM_CLKGR1, 4,  CLK_IGNORE_UNUSED,		CLK_GATE_SET_TO_DISABLE),
	GATE(CLK_GATE_IPU,      "gate_ipu",         "div_ahb0",     CPM_CLKGR1, 2,  CLK_IGNORE_UNUSED,          CLK_GATE_SET_TO_DISABLE),
	GATE(CLK_GATE_DTRNG,	"gate_dtrng",		"div_apb",	    CPM_CLKGR1, 1,  CLK_IGNORE_UNUSED,		CLK_GATE_SET_TO_DISABLE),
	GATE(CLK_GATE_EL150,	"gate_el150",		"div_el150",    CPM_CLKGR1, 0,  CLK_IGNORE_UNUSED,		CLK_GATE_SET_TO_DISABLE),
	GATE(CLK_CE_I2ST,	    "ce_i2st",		    "div_i2st",	    CPM_I2STCDR, 29, CLK_IGNORE_UNUSED, 0),
	GATE(CLK_CE_I2SR,	    "ce_i2sr",		    "div_i2sr",	    CPM_I2SRCDR, 29, CLK_IGNORE_UNUSED, 0),
	GATE(CLK_GATE_USBPHY,   "gate_usbphy",      "div_apb",      CPM_OPCR,   23, CLK_IGNORE_UNUSED,          CLK_GATE_SET_TO_DISABLE)
};
