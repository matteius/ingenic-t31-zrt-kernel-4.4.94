...
static struct ingenic_div_clock t31_div_clks[] __initdata = {
	...
	DIV(CLK_DIV_LCD,		"div_ldc",		"mux_lcd",		CPM_LPCDR,	    8,  0, NULL),
	...
	DIV(CLK_DIV_CIM,		"cgu_cim",		"mux_cim",		CPM_CIMCDR,	    8,  0, NULL),
	DIV(CLK_DIV_ISP,		"cgu_isp",		"mux_isp",		CPM_ISPCDR,	    4,  0, NULL),
...
static struct ingenic_gate_clock t31_gate_clks[] __initdata = {
	...
	GATE(CLK_GATE_MIPI_CSI, "csi",		    "div_ahb0",	    CPM_CLKGR,  25, 0, 			CLK_GATE_SET_TO_DISABLE),
	GATE(CLK_GATE_LCD,	    "ldc",		    "div_ldc",	    CPM_CLKGR,  24, 0, 			CLK_GATE_SET_TO_DISABLE),
	GATE(CLK_GATE_ISP,	    "isp",		    "cgu_isp",	    CPM_CLKGR,  23, 0, 			CLK_GATE_SET_TO_DISABLE),
	...
	GATE(CLK_GATE_OTG,	    "otg",		    "div_ahb2",	    CPM_CLKGR,  3,  0, 			CLK_GATE_SET_TO_DISABLE),
	...
	GATE(CLK_GATE_AHB0,	    "apb0",		"div_ahb0",	    CPM_CLKGR1, 10, CLK_IGNORE_UNUSED,	CLK_GATE_SET_TO_DISABLE),
	...
	GATE(CLK_GATE_EL150,	"mscaler",		"div_el150",    CPM_CLKGR1, 0,  0, 			CLK_GATE_SET_TO_DISABLE),
