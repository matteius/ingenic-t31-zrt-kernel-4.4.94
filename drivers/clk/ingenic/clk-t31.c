...
struct completion clk_initialized;
...
static const struct of_device_id t31_clk_match[] = {
        { .compatible = "ingenic,t31-clocks", },
        {},
};

static int __init t31_clk_init_dt(void)
{
    struct device_node *np;

    np = of_find_matching_node(NULL, t31_clk_match);
    if (!np) {
